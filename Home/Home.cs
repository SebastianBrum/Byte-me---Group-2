...
namespace Byte_me___Group_2
{
    ...
    public partial class Home : Form
    {
        ...
        // Stores each playlist card's cover PictureBox, keyed by the playlist's file path
        private Dictionary<string, PictureBox> playlistCoverBoxes = new Dictionary<string, PictureBox>();
